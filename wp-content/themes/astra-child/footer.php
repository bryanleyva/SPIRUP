...
<div class="spirup-cart" id="spirup-cart" hidden>
	...
	<aside class="spirup-cart__panel" role="dialog" aria-label="Carrito de compra" aria-modal="true">
		<div class="spirup-cart__head">
			<img class="spirup-cart__logo" src="<?php echo esc_url( get_stylesheet_directory_uri() . '/imagenes/logo-spirup.png' ); ?>" srcset="<?php echo esc_url( get_stylesheet_directory_uri() . '/imagenes/logo-spirup.png' ); ?> 1x, <?php echo esc_url( get_stylesheet_directory_uri() . '/imagenes/logo-spirup@2x.png' ); ?> 2x" width="154" height="186" alt="Spir Up">

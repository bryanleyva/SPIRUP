<?php
/**
 * Plantilla de pagina: Terminos y condiciones (SPIRUP).
 *
 * Se aplica a la pagina con slug "terminos-y-condiciones".
 *
 * @package SPIRUP
 */
...
<main class="spirup-main spirup-legal">
	<div class="spirup-legal__inner">
		...
		<ul class="spirup-legal__list">
			...
			<li>La disponibilidad de stock se muestra en tiempo real, pero puede agotarse durante el proceso de compra por alta demanda. En ese caso, te lo notificaremos y se te reembolsará el monto pagado.</li>
		...
		<ul class="spirup-legal__list">
			...
			<li>Aceptamos pagos mediante [tarjetas de crédito/débito, Yape, Plin] a través de nuestra pasarela de pago Culqi, que procesa la transacción bajo estándares de seguridad PCI-DSS. Spir Up no almacena los datos completos de tu tarjeta.</li>
		...
		<ul class="spirup-legal__list">
			...
			<li>Para provincias, el plazo estimado de entrega es de 4 a 7 días hábiles, dependiendo del destino y la cobertura del operador logístico.</li>
			<li>El costo de envío se calcula según el destino y se muestra antes de confirmar la compra.</li>
		</ul>
		<div class="spirup-legal__tablewrap">
			<table class="spirup-zona">
				<tbody>
					<tr class="z1">
						<td class="zname">Zona 1</td>
						<td class="zprice">S/ 10.00</td>
						<td class="zdist">La Molina, Ate, Santa Anita, San Borja, Santiago de Surco, San Luis y Surquillo.</td>
					</tr>
					<tr class="z2">
						<td class="zname">Zona 2</td>
						<td class="zprice">S/ 15.00</td>
						<td class="zdist">Miraflores, San Isidro, Barranco, Lince, La Victoria, Jesús María, Magdalena, Pueblo Libre, San Miguel, Chorrillos, San Juan de Miraflores, Cercado de Lima y Breña.</td>
					</tr>
					<tr class="z3">
						<td class="zname">Zona 3</td>
						<td class="zprice">S/ 20.00</td>
						<td class="zdist">Los Olivos, Independencia, San Martín de Porres, Rímac, Comas, Carabayllo, Puente Piedra, Villa El Salvador, Villa María del Triunfo, San Juan de Lurigancho, El Agustino, Callao, Bellavista, La Perla y Ventanilla.</td>
					</tr>
					<tr class="z4">
						<td class="zname">Zona especial</td>
						<td class="zprice">S/ 25.00 o previa coordinación</td>
						<td class="zdist">Lurín, Pachacámac, Cieneguilla, Chaclacayo, Chosica, Ancón y Santa Rosa.</td>
					</tr>
				</tbody>
			</table>
		</div>
		...
		<ul class="spirup-legal__list">
			...
			<li>Se conserve el empaque original en buen estado.</li>
			<li>El reclamo se realice dentro del plazo indicado, escribiendo a <a href="mailto:info@spirup.com">info@spirup.com</a></li>
		</ul>
		...
		<ul class="spirup-legal__list">
			...
			<li>No utilizar el Sitio con fines fraudulentos, ilícitos o que afecten a terceros.</li>
	...
	<div class="spirup-legal__law">
		<div class="spirup-legal__law-inner">
			<strong>Estos Términos y Condiciones se rigen por la Ley N° 29571 (Código de Protección y Defensa del Consumidor), el reglamento del Libro de Reclamaciones y demás normativa peruana aplicable al comercio electrónico.</strong>
		</div>
	</div>
</main>

	...
	<header class="spirup-header">
		<div class="spirup-header__inner">
			...
			<nav class="spirup-nav" id="spirup-nav" aria-label="Menu principal">
				<a href="#spir-up">Spir Up</a>
				<a href="#por-que">¿Por qué Spir Up?</a>
				<a href="#beneficios">Beneficios</a>
				<a href="#conocenos">Conócenos</a>
			</nav>

			<div class="spirup-header__actions">
				<a href="#reservar" class="spirup-btn spirup-btn--orange">Reservar</a>

				<button class="spirup-burger" type="button" aria-label="Abrir menú" aria-controls="spirup-nav" aria-expanded="false">
					<span></span><span></span><span></span>
				</button>

				<button class="spirup-iconbtn" aria-label="Buscar" type="button">
				...
				<a href="#carrito" class="spirup-iconbtn spirup-iconbtn--cart" aria-label="Carrito">
